			...
			<div class="col-md-12">
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<?php echo form_open('home/tambahkaryawan', ['class' => 'form-horizontal', 'method' => 'post']); ?>
							<div class="form-group <?php echo (form_error('id_kar') != '') ? 'has-error has-feedback' : '' ?>">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="id_kar" value="<?php echo set_value('id_kar'); ?>">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="nama_kar" value="<?php echo set_value('nama_kar'); ?>">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="lahir" value="<?php echo set_value('lahir'); ?>">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="jabatan_kar" value="<?php echo set_value('jabatan_kar'); ?>">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
							 		<select <?php echo set_value('gender'); ?> name="gender" class="form-control">
